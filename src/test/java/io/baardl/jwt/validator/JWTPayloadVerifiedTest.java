...
public class JWTPayloadVerifiedTest {
    ...
    private String userToken = null; //Insert a valid base64UrlEncoded token


    @Before
    public void setUp() throws Exception {
        assertNotNull("You need to set an valid userToken", userToken);
    }

    @Test
    public void parseUserFromUserToken() {
//        boolean user = JWTValidator.validateUserToken(userToken, jwksJson);
        String user = JWTPayloadVerified.parseUserFromUserToken(userToken, jwksJson);
        assertNotNull(user);
    }

    @Test
    public void findPayloadFromUserToken() {
    }
}